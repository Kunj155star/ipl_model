...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.19656660.svg)](https://doi.org/10.5281/zenodo.19656660)

> **Citation:** Vadakkan, K.I. (2026). Computational Model of Inter-Postsynaptic Links (IPLs).  
> GitHub repository. https://doi.org/10.5281/zenodo.19656660
...
- **ipl_model.py**: Full implementation with statistical analysis (30 runs)
- **ipl_comprehensive.png**: Visualization of results with error bars
- **IPL_model_results_n30.json**: Complete statistical results
